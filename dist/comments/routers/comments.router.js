...
exports.commentsRouter
    ...
    .put('/:commentId/like-status', access_token_guard_1.accessTokenGuard, comment_id_validation_1.commentIdValidationMiddleware, likeQueryValidation, input_validtion_result_middleware_1.inputValidationResultMiddleware, commentsController.updateLikeHandler.bind(commentsController));
