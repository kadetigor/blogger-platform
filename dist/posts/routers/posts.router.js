...
exports.postsRouter
    ...
    .put('/:postId/like-status', access_token_guard_1.accessTokenGuard, post_id_validation_middleware_1.postIdValidationMiddleware, like_query_validation_middleware_1.likeQueryValidation, input_validtion_result_middleware_1.inputValidationResultMiddleware, post_exists_validation_1.validatePostExistsMiddleware, postsController.updateLikeHandler.bind(postsController));
