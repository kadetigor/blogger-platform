...
exports.postsRouter
    ...
    .post('/:id/comments', access_token_guard_1.accessTokenGuard, params_id_validation_middleware_1.idValidationMiddleware, comment_input_dto_validation_1.contentValidation, input_validtion_result_middleware_1.inputValidationResultMiddleware, create_comment_handler_1.createCommentHandler)
    .get('/:id/comments', params_id_validation_middleware_1.idValidationMiddleware, input_validtion_result_middleware_1.inputValidationResultMiddleware, get_comment_list_handler_1.getCommentListHandler);
