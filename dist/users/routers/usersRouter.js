...
exports.usersRouter
    .get('/', basic_guard_middleware_1.superAdminGuardMiddleware, (0, queryPaginationSortingValidationMiddleware_1.paginationAndSortingValidation)(userSortField_1.userSortField), input_validtion_result_middleware_1.inputValidationResultMiddleware, getUserListHandler_1.getUserListHandler)
    .post('/', basic_guard_middleware_1.superAdminGuardMiddleware, userInputDtoValidation_1.userInputDtoValidation, input_validtion_result_middleware_1.inputValidationResultMiddleware, createUserHandler_1.createUserHandler)
    .delete('/:id', basic_guard_middleware_1.superAdminGuardMiddleware, params_id_validation_middleware_1.idValidationMiddleware, input_validtion_result_middleware_1.inputValidationResultMiddleware, deleteUserHandler_1.deleteUserHandler);
