...
const refreshTokenSessionSchema = new Schema<SecurityDeviceDocument>({
...
export const SecurityDeviceModel = model<SecurityDeviceDocument>('RefreshTokenSession', refreshTokenSessionSchema)