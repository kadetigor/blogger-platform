...
export const SETTINGS = {
    ...
    REFRESH_SECRET: process.env.REFRESH_SECRET || "375716583cc6637f4f9e545fbf8e53f9cf53db3aab85760af7e9a7bc9bba22ed9d90e9fe528c191bf367ee72f2f27be2c34776fe08bafd32abfb5303eb6be142",
    REFRESH_TIME: process.env.REFRESH_TIME || 600,
};